...
| BR-12 | **Свойства материалов** | Необходимые свойства материалов подтягиваются из библиотеки материалов применяемых на предприятии. На данный момент сервис отсутствует, но JSON файлы есть. |
