...
def report_condenser_pressure(pressure_condenser: float | None, 
    ...
    """
    print("--- Новый расчет ---")
    print(f"Входные данные:\n  Pк (pressure_condenser) = {pressure_condenser}\n  tов1 (temperature_cooling_water_1) = {temperature_cooling_water_1}\n  PIF = {pif}")
    ...
    if result is not None:
        ...
        print(f"  Ни одно из условий методологии не выполнено. Результат не определен.")
