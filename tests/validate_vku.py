...
def run_validation():
    ...
    strategy = VKUStrategy(
        mass_flow_steam_nom=mass_flow_nom,
        degree_dryness_steam_nom=dryness_nom
    )
    ...
    validation_data = {
        ...
        'P_expected': [0.091366573, 0.13082959, 0.162134878, 0.077804347, 0.112168783, 0.139803093, 0.067811128, 0.098300643, 0.122569889, 0.134806483, 0.146941106, 0.126750725, 0.157444183, 0.156322495]
    }
